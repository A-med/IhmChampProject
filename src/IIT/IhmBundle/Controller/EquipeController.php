...
use IIT\IhmBundle\Entity\Equipe;
use IIT\IhmBundle\Form\EquipeType;
...
class EquipeController extends Controller {
    ...
    public function indexAction() {
        ...
        $entities = $em->getRepository('IITIhmBundle:Equipe')->findAll();
     ...
     * @Method("POST")
     * @Template("IITIhmBundle:Equipe:new.html.twig")
     */
    ...
    public function showAction($id) {
        ...
        $entity = $em->getRepository('IITIhmBundle:Equipe')->find($id);
     ...
     * @Method("PUT")
     * @Template("IITIhmBundle:Equipe:edit.html.twig")
     */
