...
use IIT\IhmBundle\Entity\Date;
use IIT\IhmBundle\Form\DateType;
...
class DateController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('IITIhmBundle:Date')->findAll();
     ...
     * @Method("POST")
     * @Template("IITIhmBundle:Date:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('IITIhmBundle:Date')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("IITIhmBundle:Date:edit.html.twig")
     */
