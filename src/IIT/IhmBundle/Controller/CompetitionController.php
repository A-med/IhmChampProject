...
use IIT\IhmBundle\Entity\Competition;
use IIT\IhmBundle\Form\CompetitionType;
...
class CompetitionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('IITIhmBundle:Competition')->findAll();
     ...
     * @Method("POST")
     * @Template("IITIhmBundle:Competition:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('IITIhmBundle:Competition')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("IITIhmBundle:Competition:edit.html.twig")
     */
