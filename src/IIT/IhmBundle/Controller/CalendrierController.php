...
use IIT\IhmBundle\Entity\Calendrier;
use IIT\IhmBundle\Form\CalendrierType;
...
class CalendrierController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('IITIhmBundle:Calendrier')->findAll();
     ...
     * @Method("POST")
     * @Template("IITIhmBundle:Calendrier:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('IITIhmBundle:Calendrier')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("IITIhmBundle:Calendrier:edit.html.twig")
     */
