...
function Make_Calendar(Year, Month) {
   ...
   var HTML_String = '<table style="padding-left:55px;"><tr><td valign="top"><table BORDER=6 CELLSPACING=1 cellpadding=1 FRAME="box" BGCOLOR="#BA000C" >';
      ...
      for (var i = 1; i < 8; i++) {
         if ((Loop_Counter >= First_Day) && (Day_Counter <= Days_in_Month[Month])) {
            if ((Day_Counter == Today) && (Year == Current_Year) && (Month == Current_Month)) {
               ...
               HTML_String += '<td BGCOLOR="FFFFFF" BORDERCOLOR="000000" style="width:40px;height:40px;">' + Day_Counter + '</td>';
            }
            Day_Counter++;    
         }
         else {
