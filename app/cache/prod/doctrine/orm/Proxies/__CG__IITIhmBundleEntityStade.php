 ...
 */
class Stade extends \IIT\IhmBundle\Entity\Stade implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'IIT\\IhmBundle\\Entity\\Stade' . "\0" . 'id', '' . "\0" . 'IIT\\IhmBundle\\Entity\\Stade' . "\0" . 'designation', '' . "\0" . 'IIT\\IhmBundle\\Entity\\Stade' . "\0" . 'pays', '' . "\0" . 'IIT\\IhmBundle\\Entity\\Stade' . "\0" . 'adresse');
        }
